...
Given a requirements document, the system can automatically execute the implementation. The architecture is as follows:
- LangGraph handles task orchestration, state management, dependency scheduling, parallelism, retries, and dynamic re-planning; 
- OpenCode handles actually entering the code repository to execute coding tasks. Git Worktree provides isolation.
